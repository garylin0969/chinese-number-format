...
exports.numberToYear = numberToYear;
exports.dateToChinese = dateToChinese;
...
function numberToYear(year, locale = 'zh-TW') {
    return (0, numberToChinese_1.default)(year, { locale, units: false });
}
/**
 * 將 Date 物件轉換為中文日期字串。
 *
...
function dateToChinese(date, options = {}) {
    ...
    const monthStr = (0, numberToChinese_1.default)(month, { locale });
    const dayStr = (0, numberToChinese_1.default)(day, { locale });
    ...
    if (format === 'time') {
        // 簡單實作：二十四小時制
        // 13:05 -> 十三點零五分
        const hourStr = (0, numberToChinese_1.default)(hours, { locale });
        let minuteStr = (0, numberToChinese_1.default)(minutes, { locale });
        if (minutes < 10) {
            // "零五"
