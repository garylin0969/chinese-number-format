...
exports.UNIT_MAP = exports.CHINESE_TO_NUMBER_MAP = exports.CONFIGS = void 0;
/**
 ...
 */
exports.CHINESE_TO_NUMBER_MAP = new Map();
/**
 * 單位權重映射表。
 * key: 單位字元 (如 '萬'), value: 權重數值 (如 10000)
 */
exports.UNIT_MAP = new Map();
// 初始化 CHINESE_TO_NUMBER_MAP
// 將 CONFIGS.base 中的所有數字變體映射到其數值
Object.entries(exports.CONFIGS.base).forEach(([numStr, chars]) => {
    if (['.', '%', '/'].includes(numStr))
        return;
    const num = parseInt(numStr, 10);
    chars.forEach((char) => exports.CHINESE_TO_NUMBER_MAP.set(char, num));
});
// 初始化 UNIT_MAP
// 1. 小單位 (十, 百, 千)
const smallUnits = {
...
Object.entries(smallUnits).forEach(([val, chars]) => {
    ...
    chars.forEach((char) => exports.UNIT_MAP.set(char, value));
});
// 2. 大單位 (萬, 億...)
// 根據 CONFIGS 中的定義，每隔 4 個數量級 (10^4) 遞增
const bigUnitsMap = [exports.CONFIGS['zh-TW'].bigUnits, exports.CONFIGS['zh-CN'].bigUnits];
